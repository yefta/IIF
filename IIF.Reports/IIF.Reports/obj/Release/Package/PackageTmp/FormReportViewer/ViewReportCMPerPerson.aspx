<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewReportCMPerPerson.aspx.cs" Inherits="IIF.Reports.Report_CM.ViewReportCMPerPersion" %>
				...
				<tr>
					<td>
						<rsweb:ReportViewer AsyncRendering="false" ID="rptView" runat="server" Font-Names="Verdana" Font-Size="8pt"
							...
							<LocalReport ReportPath="Report\ReportTATReportCMperPerson.rdlc" /></rsweb:ReportViewer>
					</td>
				</tr>
			</table>
        </div>
