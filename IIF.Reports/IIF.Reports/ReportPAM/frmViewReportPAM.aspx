<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmViewReportPAM.aspx.cs" Inherits="IIF.Reports.ReportPAM.frmViewReportPAM" %>
            ...
            <tr>
                <td>
                    <rsweb:ReportViewer AsyncRendering="false" ID="rptView" runat="server" Font-Names="Verdana" Font-Size="8pt"
                        ...
                        <LocalReport ReportPath="ReportPAM\ReportPAM.rdlc" />
                    </rsweb:ReportViewer>
                </td>
            </tr>
        </table>
