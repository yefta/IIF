...
namespace IIF.PAM.MergeDocumentServices.Models
{
    public class CMData
    {
        ...
        public string FacilityLimitComplianceCurrencyId { get; set; }
        public string FacilityLimitComplianceMonth { get; set; }
        public string FacilityLimitComplianceYear { get; set; }
        ...
        public string FacilityLimitComplianceRiskRatingId { get; set; }
